...
<script>
    ...
    function load_map() {
        mapboxgl.accessToken = 'pk.eyJ1IjoianVzdGluZ3JlZXI3NTAiLCJhIjoiY20ybTc0bXRrMGtjZTJucHZzczRyc3h4bSJ9.wuaEcaGJg-0-wCxDr7W1IA';
        ...
        map.loadImage(
            'https://openflights.local/assets/plane.png',
            (error, image) => {
